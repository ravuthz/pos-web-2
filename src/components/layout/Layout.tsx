                ...
                <div className="navbar min-h-0 gap-3 px-0 py-0">
                  <div className="navbar-start min-w-0 flex-1 gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-sm font-medium text-surface-900">POS Web2</p>
                        ...
                        {isCollapsibleGroup && !isGroupExpanded ? null : (
                          <div
                            className={`grid gap-1 ${
                              isCollapsibleGroup ? 'ml-3 border-l border-base-300/70 pl-3' : ''
                            }`}
                          >
                            {group.items.map((item) => {
                              ...
                              return (
                                <Link
                                  key={item.to}
                                  to={item.to}
                                  className={`btn btn-ghost h-auto min-h-0 w-full items-center justify-start gap-3 rounded-[calc(var(--radius-field)*1.1)] border-0 px-3 py-2.5 text-left text-sm font-medium normal-case text-surface-700 shadow-none ${
                                    isActive
